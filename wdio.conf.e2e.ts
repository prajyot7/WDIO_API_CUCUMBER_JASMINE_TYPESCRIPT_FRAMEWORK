...
import FrameworkConstants from './test/static/FrameworkConstants';
...
export const config: Options.Testrunner = {
    ...
    exclude: [],
    // exclude: ['./test/cucumber/features/**/register.feature'],
    suites: {
        smoke: ['./test/cucumber/features/smoke/*.feature'],
        regression: ['./test/cucumber/features/regression/*.feature']
    },
    // Patterns to exclude.
    ...
    cucumberOpts: {
        ...
        require: ['./test/cucumber/step-definitions/*.ts'],
